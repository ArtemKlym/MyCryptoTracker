...
class CoinListViewModelAndroidTest {

    private lateinit var fakeCoinDataSource: FakeCoinDataSourceAndroid
    ...
    fun setup() {
        ...
        fakeCoinDataSource = FakeCoinDataSourceAndroid().apply {
            addCoins(
    ...
    @Test
    fun loadCoinsShouldUpdateStateWithCoins() = testScope.runTest {
